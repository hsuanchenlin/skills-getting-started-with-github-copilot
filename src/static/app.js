document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderParticipantItem(activityName, participant) {
    return `
      <li class="participant-item">
        <span class="participant-item__email">${escapeHtml(participant)}</span>
        <button
          type="button"
  ...
  function renderActivityCard(name, details) {
    ...
    const participantItems = details.participants.length
      ? details.participants.map((participant) => renderParticipantItem(name, participant)).join("")
